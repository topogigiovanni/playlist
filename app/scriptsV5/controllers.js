...
app.controller('SearchController', ['$scope', '$rootScope', 'Search', function ($scope, $rootScope, Search) {
  $scope.resultItems = Search.resultItems;
  $rootScope.$on('Search.DateReceived', function(e, data){
    //console.log('on Search.DateReceived',e, data);
