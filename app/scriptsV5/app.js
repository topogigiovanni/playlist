...
var YTKey = 'AIzaSyDdNn7Fj9e0_gIURLfIDm9Cg8ubNzhmmQU%20';
...
function YoutubeVideo(url, callback){
  ...
  //   callback(r);
  // });
 $.get('https://www.googleapis.com/youtube/v3/videos?id='+id+'&key='+YTKey+'&part=snippet,contentDetails&fiel=title', 
    callback
    );
